            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <?php if (is_logged_in()) : ?>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu bg-white" aria-labelledby="rolesDropdown">
                            <li><a class="dropdown-item" href="<?php echo get_url('accountCreating.php'); ?>">Create Account</a></li>
                            <li><a class="dropdown-item" href="<?php echo get_url('accountsOwn.php'); ?>">My Accounts</a></li>
